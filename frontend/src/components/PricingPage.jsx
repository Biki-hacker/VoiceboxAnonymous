          ...
          <div className="w-full border-t border-gray-800/50 pt-4">
            <div className="flex flex-col md:flex-row justify-between items-center">
              ...
              <div className="flex items-center space-x-4">
                <a href="https://instagram.com/nexlifystudios/" target="_blank" rel="noopener noreferrer" className="text-white hover:text-pink-500 transition-colors duration-200">
                ...
                <a href="https://threads.com/@nexlifystudios/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-black transition-colors duration-200">
