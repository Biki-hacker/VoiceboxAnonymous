...
const PricingPage = () => {
  ...
  return (
    <div className="relative overflow-x-hidden min-h-screen text-white flex flex-col bg-[#040b1d]">
      ...
      {/* Footer */}
            <footer className="relative z-10 py-8 bg-[#0A0F1F]/50 backdrop-blur-sm pointer-events-auto">
                  ...
                  <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex items-center space-x-6 relative z-20">
                      ...
                      <a 
                        ...
                        target="_blank" 
                        rel="noopener noreferrer" 
                        className="text-white hover:opacity-80 transition-opacity duration-200 relative z-10"
                        aria-label="Threads"
                      >
