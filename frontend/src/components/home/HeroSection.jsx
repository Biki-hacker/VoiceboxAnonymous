...
const HeroSection = React.forwardRef(({ controls, typedText }, ref) => {
  const FULL_HEADING = "Revolutionize Employee Feedback with Total Anonymity";
    ...
    >
      ...
      <div className="max-w-xl lg:max-w-2xl">
        <motion.h1
          ...
          className="chrome-hero-text font-bold leading-tight mb-6 text-white flex items-center"
          itemProp="name"
        >
          <span style={{ fontFamily: 'monospace' }}>
            {typedText}
            {typedText !== FULL_HEADING && (
